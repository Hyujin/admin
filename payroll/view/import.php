        ...
        <div class="table table-sm">
            <table class="table table-sm table-responsive table-striped table-hover table-light mt-3">
                    ...
                    $sql = "SELECT  employees.id, employees.fullname, employees.role, employees.emp_type, reg_manhour.total_worked_hrs, deductions.total_deductions,
                                    reg_pay.ot_pay, reg_pay.gross_pay, reg_pay.net_pay, payroll_batch.status, payroll_batch.batch_date
                            FROM reg_pay
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td scope='col'> <input style='border: 0;' type='text' size='8' name='pay_sched' class='hidden text-center'  value=\"" .$row['batch_date']. "\"></td>";
                                    echo "<td scope='col'> <input style='border: 0;' type='text' size='5' name='visibility' class='hidden text-center' disabled value=\"" .$row['status']. "\"></td>";
